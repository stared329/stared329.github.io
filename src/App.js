  ...
  return (
    <div className="root-back min-h-screen">
      <div className="flex w-full justify-center overflow-auto opacity-95">
        <div
          className={`container max-w-md mx-auto h-full text-back ${
              ...
              <div>
                ...
                <div className="pl-4">
                  ...
                  <div>
                    ...
                    <div className="inline-flex">
                      ...
                      <span>
                        301, 320, 10, 11-1, 11-2(일반), 83, 88, 510, 530, 662,
                        6018, N16, 구로09(마을), 양천04(마을)
                      </span>
                    </div>
                  </div>
                </div>
                <div className="mt-2 pl-4">
                  ...
                  <div className="inline-flex">
                    <span className="opacity-80 shrink-0 mr-1">[간선]</span>
                    <span>
                      5619, 6411, 6511, 6611, 영등포01, 영등포08, 영등포09,
                      영등포, 영등포13
                    </span>
                  </div>
                </div>
